...
export function buildAgentReviewPacket(
  ...
  return [
    ...
    "",
    "Local lexical checks are hints, not semantic verdicts. The chapter-length target is a soft warning; only output below 80% of the target minimum fails the local structural floor. An anchor existing does not prove that the body teaches the answer.",
    "",
    "## Files to review",
    "",
    ...
    "3. Internal consistency: terminology, symbols, claims, and examples do not contradict each other.",
    ...
    "6. Learning efficiency: useful depth near the target length without glossary or textbook sprawl.",
